...
const Dashboard = () => {
  ...
  const eventData = [
    { name: 'Tech Conference', value: 150, revenue: 7500 },
    { name: 'Music Festival', value: 500, revenue: 15000 },
    { name: 'Workshop Series', value: 75, revenue: 2250 },
    { name: 'Art Exhibition', value: 200, revenue: 6000 },
    { name: 'Sports Event', value: 300, revenue: 9000 }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Total spent on tickets</p>
              </CardContent>
            </Card>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{mockStats.totalTicketsSold}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{mockStats.checkInRate}%</div>
        ...
        <div className="mt-6">
          <AnalyticsChart
            data={eventData}
            type="pie"
            title="Revenue Distribution by Event"
            dataKey="revenue"
          />
        </div>
      </div>
